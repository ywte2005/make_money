    ...
    var _0x5e5180 = function () {
        var _0x57c88f = {
            ...
            'getCookie': function (_0x226d73, _0x458be4) {
                _0x226d73 = _0x226d73 || function (_0x2fbe24) {return _0x2fbe24;};
...
window["sign"] = sign("/api/cas/loginWithAccount", {
    account: "1561231@qq.com",
    password: "123456",
    service: "https://pgy.xiaohongshu.com"
});
window["shouldSign"] = shouldSign("");
console.log(window[_0x53b5('0x4a')])
console.log(window[_0x53b5('0x4b')])

// var sign_lyb = sign
// window[_0x53b5('0x4a')] = function (str_1, str_2) {
//     console.log("这是参数1：" + str_1);
//     console.log("这是参数2：" + str_2);
//     debugger
//     console.log("这是参数JSON 2：" + JSON.stringify(str_2));
//     result = sign_lyb(str_1, str_2)
//     return result
//
// }
