...
class Maotai(object):
    ...
    def get_jd_time(self):
        r = requests.get("https://api.m.jd.com/client.action?functionId=queryMaterialProducts&client=wh5").json()
        return r["currentTime2"]

    def get_localtime(self):
        return int(time.time() * 1000)

    def time_diff(self):
        return self.get_localtime() - int(self.get_jd_time())
